...
cfg.services = {
  ...
  ["UNIMED"] = {
    ...
    alert_notify = "~r~[UNIMED] Chamado de emergência:~n~~s~",
    notify = "~b~Você chamou a Unimed.",
    answer_notify = "~b~A Unimed está a caminho."
  },
  ["Advogado"] = {
    blipid = 269,
    blipcolor = 68,
  ...
  ["Mecanico"] = {
    ...
    answer_notify = "~y~O Mecanico está a caminho."
  }
}
