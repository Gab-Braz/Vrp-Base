...
function incoma_drawTxt(text,font,centre,x,y,scale,r,g,b,a)
  SetTextFont(4)
...
Citizen.CreateThread(function() -- coma second warning
  while true do 
    Citizen.Wait(0)
    if in_coma then
      incoma_drawTxt("~s~Você ainda tem: ~r~"..coma_left.." ~s~segundos em coma.",0,1,0.5,0.86,0.6,255,255,255,255)
    end
  end
end)