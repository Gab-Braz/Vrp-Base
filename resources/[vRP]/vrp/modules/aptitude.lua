      ...
      for k,v in pairs(uaptitudes) do
        ...
        for l,w in pairs(v) do
          ...
          if def then
            ...
            content = content.."<div class=\"dprogressbar\" data-value=\""..(percent/100).."\" data-color=\"rgba(170,0,0,0.9)\" data-bgcolor=\"rgba(170,0,0,0.4)\">"..lang.aptitude.display.aptitude({def[1], exp, lvl, percent}).."</div>"
          end
        end
      end
...
.div_user_aptitudes{
          ...
          color: white;
          font-weight: bold;
          border-bottom: 6px solid rgb(170,0,0);
          border-radius: 18px
