...
vRPclient = Tunnel.getInterface("vRP","vrp_conce")
...
RegisterServerEvent('comprar2')
AddEventHandler('comprar2', function(vehicle, price)
  ...
  MySQL.query("vRP/get_vehicle", {user_id = user_id, vehicle = vehicle}, function(pvehicle, affected)
		if #pvehicle > 0 then
			...
			if vRP.tryFullPayment({user_id,price}) then
				...
				--TriggerClientEvent("amorim:advNotify", player, 21,"Concessionária", "Você comprou seu novo ~r~"..vehicle.." com sucesso.",20)
				sendToDiscord("Concessionária", "ID: "..user_id.." ("..GetPlayerName(player)..") comprou o carro "..vehicle.. " e pagou "..price)
			else
